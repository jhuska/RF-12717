...
public abstract class AbstractManagedBean implements Serializable {
     ...
     * 
     * @param severity
     *        the severity (see {@link Severity})
     * @param summary
    ...
    /**
     * The abstract bean has no concept of where the pages it needs to forward to are located. This method
     * gives the path to the resources. Note this should also be used by any forward returns you make in your
     * implementing class as well to reduce the number of places we have to store absolute paths.
     * <p>
     * 
